...
const TrustBar = () => {
  const trustItems = [
    { icon: <MdGridView className="text-[32px]" />, text: "Microsoft Azure" },
    { icon: <MdLock className="text-[32px]" />, text: "End-to-End Encryption" },
    { icon: <MdSecurity className="text-[32px]" />, text: "GDPR Compliant" },
    { icon: <MdVerifiedUser className="text-[32px]" />, text: "SSL Secured" },
  ];
