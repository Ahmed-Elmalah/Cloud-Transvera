...
const Hero = () => {
  const { t } = useTranslation(); // 2. تعريف الدالة
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center ">
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-4 justify-center lg:justify-start">
              <button className="h-12 px-8 rounded-lg bg-linear-to-r from-primary to-blue-600 text-white font-bold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2 cursor-pointer">
                {t('hero_btn_trial')}
                <MdArrowForward className="rtl:rotate-180 text-[20px]" />
              </button>
